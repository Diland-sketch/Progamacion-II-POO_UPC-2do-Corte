...
public class RegistroController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        this.cmbTipoAlojamiento.getItems().addAll("Habitacion", "Cabaña");
    ...
    public void clickTipoAlojamiento(){
        ...
        this.cmbNoCuartos.setDisable(indexSeleccionado!=1);
        this.cmbNoPersonas.setDisable(indexSeleccionado!=0);
    }
    ...
    public void clickBtnGuardar(){
        ...
        int valor = (tipo==2)?
                ...
                :
                 Integer.parseInt(this.cmbNoPersonas.getSelectionModel().getSelectedItem().toString());
