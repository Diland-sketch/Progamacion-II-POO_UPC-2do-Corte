...
public class Logica {
    ...
    public Cotizacion crearCotizacion(LocalDate inicio, LocalDate fin, Alojamiento alojamiento) throws ExcepcionFechaAlojamiento{
        
        if(inicio.isAfter(fin)){
            throw new ExcepcionFechaAlojamiento("Las fechas no son correctas");
        }
