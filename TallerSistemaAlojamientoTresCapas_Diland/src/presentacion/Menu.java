...
//            do {
            System.out.println("-----------------------------");
                this.opcionSeleccionada = Lector.leerInt("Seleccione: ");
...
//        int codigo = this.lector.nextInt();
        int codigo = Lector.leerInt("Codigo: ");
        System.out.printf("%-20s: ", "Direccion");
        String dir = this.lector.nextLine();
        System.out.printf("%-20s: ", "Ciudad");
        String ciudad = this.lector.nextLine();
        System.out.printf("%-20s: ", "Pais");
        String pais = this.lector.nextLine();
        int tipo, valor = 0;
        do {
        ...
        switch (tipo) {
            case 1:
                ...
                valor = Lector.leerNum("Numero de personas: ");
                break;
            case 2:
                //System.out.printf("%-20s: ", "No cuartos");
                valor = Lector.leerNum("Numero de cuartos: ");
                break;
        }
    ...
    private void ejecutarOpcion2() {
        ...
        if (alojamiento != null) {
            ...
            dia = Lector.leerDia("Dia: ");
            //System.out.printf("%-10s: ", "mes");
            mes = Lector.leerMes("Mes: ");
            //System.out.printf("%-10s: ", "año");
            anio = Lector.leerAnio("Año :");
            ...
            catch(ExcepcionFechaAlojamiento e){
